...
const SUPPORT_FORM_URL = 'https://forms.gle/BsiCqjt68pGTjsrG7';
...
module.exports = {
  ...
  SESSION_ID_MAX_LENGTH, MAX_PHONES_PER_SESSION, MIN_SEND_DELAY_MS, DEFAULT_SEND_DELAY_MS,
  ...
  AUDIT_RETENTION_DAYS, AUDIT_RETENTION_MS,
  UPDATE_CHECK_INITIAL_MS, UPDATE_CHECK_INTERVAL_MS,
  SESSION_TTL_MS, SEND_MAX_RETRIES, SEND_RETRY_BASE_MS, SUPPORT_FORM_URL,
